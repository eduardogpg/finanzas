...
class Address(models.Model):
    ...
    class TOWNSHIPS(models.TextChoices):
        ...
        CACAHOATÁN = 'Cacahoatán', _('Cacahoatán'),
        CATAZAJÁ = 'Catazajá', _('Catazajá'),
        ...
        CHALCHIHUITÁN = 'Chalchihuitán', _('Chalchihuitán'),
        ...
        JUÁREZ = 'Juárez', _('Juárez'),
        LARRÁINZAR = 'Larráinzar', _('Larráinzar'),
        ...
        SAN_CRISTÓBAL_DE_LAS_CASAS = 'San Cristóbal de las Casas', _('SanCristóbal de las Casas'),
        ...
        UNION_JUÁREZ = 'UniónJuárez', _('UniónJuárez'),
        ...
        CAPITÁN_LUIS_ANGEL_VIDAL = 'Capitán Luis Angel Vidal', _('Capitán Luis Angel Vidal'),
